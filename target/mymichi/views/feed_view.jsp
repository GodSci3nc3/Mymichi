...
<%@ page import="java.util.List, com.mymichi.utils.Publicacion" %>
            ...
            <body>
                <div class="header">
                    ...
                    <% String username=(String)session.getAttribute("username"); byte[]
                        photoBytes=(byte[])session.getAttribute("photo"); %>
                        ...
                        <div class="navbar">
                                ...
                                <div class="search-results" id="searchResults">
                                    <div class="info-result">
                                        <img src="../assets/profile-photo.png" alt="Foto de perfil"
                                            style="width: 80px; border-radius: 505px;">
                            ...
                            <div class="profile">
                                ...
                                <a href="/mymichi/getMyPost"><img
                                        style="width: 80px; border: 2px solid #55589E; border-radius: 505px;"
                                        src="/mymichi/imageServlet" /></a>
                            </div>
                        </div>
                </div>
                ...
                <div class="scrollable">
                    ...
                    <div class="goPublish">
                        <img style="width: 90px; border: 2px solid #55589E; border-radius: 505px;"
                            src="/mymichi/imageServlet" href="profile_view.jsp" />
                        <a id="openCreatePublishContent"
                            style="text-decoration: none; font-size: 30px; margin-left: 65px;">En que estas
                            pensando?</a>
                    </div>
                    ...
                    <div class="createPublishContent" id="createPublishContent">
                        ...
                        <div class="createPublishContentForm">
                            <form action="/mymichi/newPost" id="createMyPublish" method="post"
                    ...
                    <!-- Botón para recargar las publicaciones-->
                    <div class="advancePublish">
                        <form action="/mymichi/checkNewPosts" method="post">
                            <button type="submit" style="text-align: center;">Cargar nuevas publicaciones</button>
                        </form>
                    </div>
                            ...
                            <form id="advanceSearchByTextAndCategory">
                                <div class="advanceSearchByText">
                                    ...
                                    <input type="text" id="texto" name="texto"
                                        placeholder="Busque publicaciones basado en texto">
                        ...
                        <% List<Publicacion> publicaciones = (List<Publicacion>) session.getAttribute("publicaciones");
                                ...
                                <div class="publication-contents">
                                    <div class="user-publication">
                                        <% if (publicacion.getImagenUsuario() !=null) { String
                                            imageDataUri="data:image/jpeg;base64," +
                                            java.util.Base64.getEncoder().encodeToString(publicacion.getImagenUsuario());
                                            %>
                                    ...
                                    <% if (publicacion.getImagen() !=null) { String
                                        imageDataUriPublication="data:image/jpeg;base64," +
                                        java.util.Base64.getEncoder().encodeToString(publicacion.getImagen()); %>
                                        <img src="<%= imageDataUriPublication %>"
                                            style="width: 350px; height: 250px; margin: 0 auto;">
                                        <% } %>
                                </div>
                                <% } } else{ response.sendRedirect("/mymichi/getPost"); } %>
                    </div>
                    <div class="pages">
                        <a href="#">1</a>
                        <a href="#">2</a>
